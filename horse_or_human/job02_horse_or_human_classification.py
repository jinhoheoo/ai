...
X_train, X_test, Y_train, Y_test = np.load('C:/workspace_intel2/python/intel_ai_s2/datasets/binary_image_data1.npy',allow_pickle=True)
...
model.save('./horse_and_human_{}.h5'.format(str(np.around(score[1],3))))
